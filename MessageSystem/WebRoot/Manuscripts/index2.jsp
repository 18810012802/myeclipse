...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <tr>
        ...
        <th>操作</th>
	     ...
	     <tr >
            ...
            <td style="vertical-align:middle;">Bin.Huang</td>
            <td style="vertical-align:middle;">
                已接受
            </td>
            <td style="vertical-align:middle;"><a href="look.jsp">查看详情</a></td>
        </tr>
  </table>
  ...
  <table class="table table-bordered table-hover definewidth m10" >
  	<tr><th colspan="5">  <div class="inline pull-right page">
         ...
         <button type="button" class="btn btn-success" id="delPro">编辑我的约稿</button>
          <button type="button" class="btn btn-success" id="delPro">进入我的草稿箱</button>
