...
<body>
<form action="UpdateInfoServlet"  method="post" enctype="multipart/form-data" class="definewidth m20">
    ...
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td><input type="text" name="name" value="${ms.name }"/></td>
        </tr>
        <tr>
            <td class="tableleft">期号<span style="color:red">*</span></td>
            <td><input type="text" name="number" value="${ms.number }"/></td>
        </tr>
        <tr>
            <td class="tableleft">内容<span style="color:red">*</span></td>
            <td><textarea name="content" id="" class="control-row4 input-large">${ms.content }</textarea></td>
        </tr>
        <tr>
            <td class="tableleft">上报截止时间<span style="color:red">*</span></td>
            <td><input type="text" name="endDate"  value="${ms.endDate }" /></td>
        </tr>
         <tr>
