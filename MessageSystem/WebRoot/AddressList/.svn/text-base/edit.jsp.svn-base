...
Add_bookService bookService=new Add_bookServiceImpl();
 List<Add_book> books=bookService.select(1,0);
 %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
<head>
<base href="<%=basePath%>">
<title>修改医生--理博软件--2016</title>
<meta charset="UTF-8">
	...
	<form action="index.jsp" method="post" class="definewidth m20">
		<table class="table table-bordered table-hover definewidth m10">
			...
			<tr>
				...
				<td><input type="text" name="pname" id="tel" onblur="checkinfo();"/></td>
							<span id="msg2"></span>
				
			</tr>
			<tr>
				<td width="10%" class="tableleft">性别</td>
				<td><input type="radio" name="pname" value="" checked id="sex" />男&nbsp;&nbsp;&nbsp;<input
					type="radio" name="pname" value="" />女</td>
			</tr>
			<tr>
				<td width="10%" class="tableleft">出生年月</td>
				<td><input type="text" name="pname" id="birthday" /></td>
			</tr>
			<tr>
				<td width="10%" class="tableleft">电子邮箱</td>
				<td><input type="text" name="pname" id="email" /></td>
					<span id="msg3"></span>
		
			</tr>
			<tr>
				<td width="10%" class="tableleft">地址</td>
				<td><input type="text" name="pname" id="address" /></td>
			</tr>
			<tr>
				<td colspan="2">
					<center>
						<button type="submit" class="btn btn-primary" type="button"><a href="UpdateBookServlet">保存</a></button>
						&nbsp;&nbsp;
						<button type="button" class="btn btn-success" name="backid"
							id="backid"><a href="innerServlet?type=personal">返回列表</a></button>
					</center>
				</td>
			</tr>
		</table>
