...
public class ExcelSendEmailServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 创建excel表头部分
		String[] excelHeader = { "标题", "内容", "发件人", "接收时间" };
		// 创建集合（从数据库中查询出来）
		...
		// 创建sheet
		HSSFSheet sheet = wb.createSheet("我的邮件信息表");
		// 创建行
		...
		response.setHeader("Content-disposition",
				"attachment;filename=myemail.xls");
		// 通过输出流将文件输出到客户端
