...
<DL class="search clearfix">
  ...
  <UL>
    ...
    <LI>标题：<INPUT class=text type=text name="title"> <LABEL class=ui-blue><INPUT value=搜索房屋 type=submit name=search></LABEL> 
...
<DIV class=houseinfo>
<P>户　　型：<SPAN>${msg.types.name }</SPAN></P>
<P>面　　积：<SPAN>${msg.floorage }m<SUP>2</SUP></SPAN></P>
<P>位　　置：<SPAN>${msg.street.name }</SPAN></P>
<P>联系方式：<SPAN>${msg.contact }</SPAN></P></DIV></DIV>
<DIV class=side>
<P><A class=bold href="http://localhost:8080/House-2/#">北京理博房地产经纪有限公司</A></P>
<P>资质证书：有</P>
<P>内部编号:1000</P>
<P>联 系 人：于洋</P>
<P>联系电话：110<SPAN></SPAN></P>
<P>手机号码：<SPAN>暂无</SPAN></P></DIV>
<DIV class=clear></DIV>
<DIV class=introduction>
<H2><SPAN><STRONG>房源详细信息</STRONG></SPAN></H2>
<DIV class=content>
<P>${msg.description }</P></DIV></DIV></DIV></DIV>
